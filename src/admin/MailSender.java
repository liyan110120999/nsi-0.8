...
//						获取内容
						...
						while(rs.next()){				
							weeklyMail.sendMail(rs.getString("mail"),title01,title02,title03,title04,title05,link01,link02,link03,link04,link05);
					...
					{
						e.printStackTrace();
						System.out.println("MailSender.java:sql异常");	
					}
//				增加邮件联系人
