			...
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li>
							 <a href="/nsi-0.8/people/People_insert.jsp">新增</a>				 
						</li>
						<li>
							 <a href="#">菜单</a>				 
						</li>
					...
					<form class="navbar-form navbar-left" id="searchForm" role="search" action="/nsi-0.8/People_servlet" name="P_Searchform" method="post">
