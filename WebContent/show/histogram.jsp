...
<html style="height: 100%">
   ...
   <body style="height: 100%; margin: 0">
        ...
        <div id="main" style="width: 1400px;height:700px;margin:5%;"></div>
...
option = {
    baseOption: {
        ...
        series: [
            ...
            {name: '房地产', type: 'bar'},
            {name: '国际学校', type: 'bar'},
            {name: '民办国际学校', type: 'bar'},
            {name: '公立学校国际班', type: 'bar'},
            {
                name: '占比',
                type: 'pie',
                center: ['75%', '35%'],
    ...
    options: [
        {
            ...
            series: [
                ...
                {data: [
                    {name: '国际学校', value: dataMap.dataPI['2002sum']},
                    {name: '民办国际学校', value: dataMap.dataSI['2002sum']},
                    {name: '公立学校国际班', value: dataMap.dataTI['2002sum']}
                ]}
            ]
        },
        {
            title : {text: '2003全国学校分布'},
            series : [
                ...
                {data: [
                    {name: '国际学校', value: dataMap.dataPI['2003sum']},
                    {name: '民办国际学校', value: dataMap.dataSI['2003sum']},
                    {name: '公立学校国际班', value: dataMap.dataTI['2003sum']}
                ]}
            ]
        },
        {
            title : {text: '2004全国学校分布'},
            series : [
                ...
                {data: [
                    {name: '国际学校', value: dataMap.dataPI['2004sum']},
                    {name: '民办国际学校', value: dataMap.dataSI['2004sum']},
                    {name: '公立学校国际班', value: dataMap.dataTI['2004sum']}
                ]}
            ]
        },
        {
            title : {text: '2005全国学校分布'},
            series : [
                ...
                {data: [
                    {name: '国际学校', value: dataMap.dataPI['2005sum']},
                    {name: '民办国际学校', value: dataMap.dataSI['2005sum']},
                    {name: '公立学校国际班', value: dataMap.dataTI['2005sum']}
                ]}
            ]
        },
        {
            title : {text: '2006全国学校分布'},
            series : [
                ...
                {data: [
                    {name: '国际学校', value: dataMap.dataPI['2006sum']},
                    {name: '民办国际学校', value: dataMap.dataSI['2006sum']},
                    {name: '公立学校国际班', value: dataMap.dataTI['2006sum']}
                ]}
            ]
        },
        {
            title : {text: '2007全国学校分布'},
            series : [
                ...
                {data: [
                    {name: '国际学校', value: dataMap.dataPI['2007sum']},
                    {name: '民办国际学校', value: dataMap.dataSI['2007sum']},
                    {name: '公立学校国际班', value: dataMap.dataTI['2007sum']}
                ]}
            ]
        },
        {
            title : {text: '2008全国学校分布'},
            series : [
                ...
                {data: [
                    {name: '国际学校', value: dataMap.dataPI['2008sum']},
                    {name: '民办国际学校', value: dataMap.dataSI['2008sum']},
                    {name: '公立学校国际班', value: dataMap.dataTI['2008sum']}
                ]}
            ]
        },
        {
            title : {text: '2009全国学校分布'},
            series : [
                ...
                {data: [
                    {name: '国际学校', value: dataMap.dataPI['2009sum']},
                    {name: '民办国际学校', value: dataMap.dataSI['2009sum']},
                    {name: '公立学校国际班', value: dataMap.dataTI['2009sum']}
                ]}
            ]
        },
        {
            title : {text: '2010全国学校分布'},
            series : [
                ...
                {data: [
                    {name: '国际学校', value: dataMap.dataPI['2010sum']},
                    {name: '民办国际学校', value: dataMap.dataSI['2010sum']},
                    {name: '公立学校国际班', value: dataMap.dataTI['2010sum']}
                ]}
            ]
        },
        {
            title : {text: '2011全国学校分布'},
            series : [
                ...
                {data: [
                    {name: '国际学校', value: dataMap.dataPI['2011sum']},
                    {name: '民办国际学校', value: dataMap.dataSI['2011sum']},
                    {name: '公立学校国际班', value: dataMap.dataTI['2011sum']}
                ]}
            ]
        }
    ]
